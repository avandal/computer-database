...
//		
//		List<ComputerDTO> list = search == null || search.equals("") ? service.getAll(mode) : service.searchByName(search, mode);
//		
//		request.setAttribute(NB_COMPUTERS, list.size());
//		
//		Optional<Integer> size = Util.parseInt(request.getParameter(PAGE_SIZE_PARAM));
//		Optional<Integer> index = Util.parseInt(request.getParameter(PAGE_INDEX_PARAM));
//		
...
//				.build();
//		
//		request.setAttribute(PAGE_SIZE_PARAM, webPage.getSize());
//		request.setAttribute(PAGE_INDEX_PARAM, webPage.getIndex());
//		
